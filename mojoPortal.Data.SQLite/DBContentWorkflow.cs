...
public static class DBContentWorkflow
{
		...
		out int totalPages)
	{
		...
		sqlCommand.Append("m.ModuleID, ");
		sqlCommand.Append("m.ModuleTitle, ");
		sqlCommand.Append("COALESCE(createdBy.Name, 'Deleted user') as CreatedByUserName, ");
		sqlCommand.Append("COALESCE(createdBy.LoginName, 'Deleted user') as CreatedByUserLogin, ");
		sqlCommand.Append("COALESCE(createdBy.Email, 'deleted@user.com') as CreatedByUserEmail, ");
		sqlCommand.Append("cwah.Notes as Notes, ");
		sqlCommand.Append("cwah.CreatedDateUtc as RecentActionOn, ");
		sqlCommand.Append("COALESCE(recentActionBy.Name, 'Deleted user') as RecentActionByUserName, ");
		sqlCommand.Append("COALESCE(recentActionBy.LoginName, 'Deleted user') as RecentActionByUserLogin, ");
		sqlCommand.Append("COALESCE(recentActionBy.Email, 'deleted@user.com') as RecentActionByUserEmail ");
