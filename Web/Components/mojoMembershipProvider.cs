...
public class mojoMembershipProvider : MembershipProvider
{
	...
	public override bool EnablePasswordReset
	{
		get
		{
			...
			return siteSettings != null && siteSettings.AllowPasswordReset;
		}
	}
	...
	public override bool EnablePasswordRetrieval
	{
		get
		{
			...
			return siteSettings != null && siteSettings.AllowPasswordRetrieval;
		}
	}
	...
	public override bool RequiresQuestionAndAnswer
	{
		get
		{
			...
			return siteSettings == null || siteSettings.RequiresQuestionAndAnswer;
		}
	}
	...
	public override bool RequiresUniqueEmail
	{
		get
		{
			...
			return siteSettings == null || siteSettings.RequiresUniqueEmail;
		}
	}
	...
	public override bool ChangePassword(string username, string oldPassword, string newPassword)
	{
		...
		var countNonAlphanumericCharacters = 0;
	...
	)
	{
		...
		if (
			...
			string.IsNullOrWhiteSpace(newPasswordQuestion) ||
			string.IsNullOrWhiteSpace(newPasswordAnswer) ||
	...
	)
	{
		...
		if (string.IsNullOrWhiteSpace(userName) || userName.Length > LoginnameMaxlength)
		{
		...
		{
			if (
				string.IsNullOrWhiteSpace(passwordQuestion) ||
			...
			if (
				string.IsNullOrWhiteSpace(passwordAnswer) ||
		...
		var nonAlphaNumericCharactersUsedCount = 0;
		...
		if (created)
		{
			if (siteSettings.UseSecureRegistration)
			{
				...
				Notification.SendRegistrationConfirmationLink(
					...
					$"{SiteUtils.GetNavigationSiteRoot()}/ConfirmRegistration.aspx?ticket={registerConfirmGuid}&returnurl={GetReturnUrl()}"
				);
			}
			else
			{
	...
	public override MembershipUser? GetUser(string username, bool userIsOnline)
	{
		...
		if (siteSettings != null && !string.IsNullOrWhiteSpace(username))
		{
			var siteUser = new SiteUser(siteSettings, username);
