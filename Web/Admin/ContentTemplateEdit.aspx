<%@ Page Language="C#" AutoEventWireup="false" MasterPageFile="~/App_MasterPages/layout.Master" CodeBehind="ContentTemplateEdit.aspx.cs" Inherits="mojoPortal.Web.AdminUI.ContentTemplateEditPage" %>
		...
		<div class="modulecontent">
			...
			<div id="divtabs" class="mojo-tabs">
				...
				<div id="tabDescription">
					...
					<div class="settingrow">
						<mp:SiteLabel ID="lblLogo" ForControl="ddImage" runat="server" CssClass="settinglabel" ConfigKey="ContentTemplateImageLabel" EnableViewState="false">
						</mp:SiteLabel>
			...
			<div class="settingrow">
				<mp:SiteLabel ID="SiteLabel1" runat="server" CssClass="settinglabel" ConfigKey="spacer" ResourceFile="Resource" />
