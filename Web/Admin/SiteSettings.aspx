					...
					<asp:Panel ID="pnlSiteSettings" runat="server" DefaultButton="btnSave">
						...
						<div id="divtabs" class="mojo-tabs">
							...
							<div id="tabSettings">
								...
								<div id="divMyPage" runat="server" class="settingrow">
									<mp:SiteLabel ID="Sitelabel20" ForControl="chkEnableMyPageFeature" runat="server"
										CssClass="settinglabel" ConfigKey="SiteSettingsEnableMyPageFeatureLabel" EnableViewState="false"></mp:SiteLabel>
								...
								<div id="divMyPageSkin" runat="server" class="settingrow">
									<mp:SiteLabel ID="SiteLabel45" runat="server" CssClass="settinglabel" ConfigKey="MyPageSkinLabel"></mp:SiteLabel>
								...
								<div id="divSecurityTabs" class="mojo-tabs">
									...
									<div id="tabGeneralSecurity" runat="server">
										<asp:Panel ID="pnlUserSecurity" runat="server" SkinID="plain">
											...
											<div class="settingrow">
												<mp:SiteLabel ID="SiteLabel63" runat="server" CssClass="settinglabel" ConfigKey="spacer"></mp:SiteLabel>
											</div>
										</asp:Panel>
									</div>
									<div id="tabLDAP" runat="server">
										...
										<asp:Panel ID="pnlLdapSettings" runat="server" SkinID="plain">
											...
											<div class="settingrow">
												<mp:SiteLabel ID="SiteLabel62" runat="server" CssClass="settinglabel" ConfigKey="spacer"></mp:SiteLabel>
											</div>
										</asp:Panel>
									...
									<div id="tabOpenID" runat="server">
										...
										<div class="settingrow">
											<mp:SiteLabel ID="SiteLabel61" runat="server" CssClass="settinglabel" ConfigKey="spacer"></mp:SiteLabel>
										</div>
										<div class="settingrow">
									...
									<div id="tabWindowsLiveID" runat="server">
										...
										<div class="settingrow">
											<mp:SiteLabel ID="SiteLabel60" runat="server" CssClass="settinglabel" ConfigKey="spacer"></mp:SiteLabel>
										</div>
									...
									<div id="tabAntiSpam">
										...
										<div class="settingrow">
											<mp:SiteLabel ID="SiteLabel58" runat="server" CssClass="settinglabel" ConfigKey="spacer"></mp:SiteLabel>
										</div>
							...
							<div id="tabApiKeys">
								...
								<div class="settingrow">
									<mp:SiteLabel ID="SiteLabel64" runat="server" CssClass="settinglabel" ConfigKey="spacer"></mp:SiteLabel>
								</div>
							</div>
							<div id="tabMailSettings" runat="server" class="minheightpanel" visible="false">
								...
								<div class="settingrow">
									<mp:SiteLabel ID="SiteLabel65" runat="server" CssClass="settinglabel" ConfigKey="spacer"></mp:SiteLabel>
								</div>
							</div>
						</div>
