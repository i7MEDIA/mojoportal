			...
			<portal:OuterBodyPanel ID="pnlOuterBody" runat="server" SkinID="admin">
				<portal:InnerBodyPanel ID="pnlInnerBody" runat="server" CssClass="modulecontent">
					<asp:Panel ID="pnlSiteSettings" runat="server" DefaultButton="btnSave">
						<portal:FormGroupPanel runat="server" CssClass="">
							<mp:SiteLabel ID="lblSiteTitle" ForControl="txtSiteName" runat="server" CssClass="settinglabel"
								ConfigKey="SiteSettingsSiteTitleLabel" EnableViewState="false" />
						...
						<div id="divtabs" class="mojo-tabs">
							...
							<div id="tabSettings">
								...
								<portal:FormGroupPanel runat="server" ID="fgpTimeZone" Visible="false">
									<mp:SiteLabel ID="SiteLabel84" runat="server" CssClass="settinglabel" ConfigKey="TimeZone" />
								...
								<portal:FormGroupPanel runat="server">
									<mp:SiteLabel ID="SiteLabel101" runat="server" CssClass="settinglabel" ConfigKey="MobileSkin"></mp:SiteLabel>
								...
								<portal:FormGroupPanel runat="server" CssClass="logolist">
									<mp:SiteLabel ID="lblLogo" ForControl="ddLogos" runat="server" CssClass="settinglabel"
										ConfigKey="SiteSettingsSiteLogoLabel" EnableViewState="false" />
								...
								<portal:FormGroupPanel runat="server">
									<mp:SiteLabel ID="SiteLabel78" runat="server" ForControl="ddNewsletterEditor" CssClass="settinglabel"
										ConfigKey="NewsletterEditorLabel" EnableViewState="false" />
								...
								<portal:FormGroupPanel runat="server" ID="fgpAllowHideMenu">
									<mp:SiteLabel ID="Sitelabel2y" runat="server" ForControl="chkAllowHideMenuOnPages"
										CssClass="settinglabel" ConfigKey="SiteSettingsAllowHideMainMenuLabel" />
								...
								<portal:FormGroupPanel runat="server" ID="fgpReallyDeleteUsers">
									...
									<mp:SiteLabel ID="SitelabelReallyDeleteUsersExplain" runat="server" ConfigKey="SiteSettingsReallyDeleteUsersExplainLabel" />
								...
								<portal:FormGroupPanel runat="server" ID="fgpApprovalsWorkflow">
									...
									<mp:SiteLabel ID="Sitelabel57" runat="server" />
								...
								<portal:FormGroupPanel runat="server">
									...
									<portal:mojoHelpLink runat="server" ID="MojoHelpLink65" HelpKey="sitesettings-opensearchname-help" />
								</portal:FormGroupPanel>
								<portal:FormGroupPanel runat="server">
							...
							<div id="tabSecurity" runat="server">
								<div id="divSecurityTabs" class="mojo-tabs">
									<ul>
										...
										<li id="liOpenID" runat="server" EnableViewState="false">
										...
										<asp:Panel ID="pnlLdapSettings" runat="server" SkinID="plain">
											...
											<portal:FormGroupPanel runat="server" ID="fgpLdapTestPassword">
												<mp:SiteLabel ID="Sitelabel9" ForControl="txtLdapTestPassword" ConfigKey="SiteSettingsLdapTestPassword"
													CssClass="settinglabel" runat="server" />
									...
									<div id="tabWindowsLiveID" runat="server">
										<portal:FormGroupPanel runat="server">
											<mp:SiteLabel ID="Sitelabel32" runat="server" ForControl="chkAllowWindowsLiveAuth"
												CssClass="settinglabel" ConfigKey="SiteSettingsAllowWindowsLiveAuthLabel" />
										...
										<portal:FormGroupPanel runat="server" ID="fgpLiveMessenger">
											<mp:SiteLabel ID="Sitelabel50" runat="server" ForControl="chkAllowWindowsLiveMessengerForMembers"
												CssClass="settinglabel" ConfigKey="AllowLiveMessengerOnProfilesLabel" />
									...
									<asp:UpdatePanel ID="upFeatures" UpdateMode="Conditional" runat="server">
										<ContentTemplate>
											<portal:FormGroupPanel runat="server" SkinID="SiteFeaturesLeft">
												<h3>
													<mp:SiteLabel ID="Sitelabel4" runat="server" ConfigKey="SiteSettingsSiteAvailableFeaturesLabel" UseLabelTag="false" />
											...
											<portal:FormGroupPanel runat="server" SkinID="SiteFeaturesRight">
												<h3>
													<mp:SiteLabel ID="Sitelabel5" runat="server" ConfigKey="SiteSettingsSiteSelectedFeaturesLabel" UseLabelTag="false" />
												</h3>
												<asp:ListBox ID="lstSelectedFeatures" runat="Server" SelectionMode="Multiple" />
											</portal:FormGroupPanel>

											<portal:FormGroupPanel runat="server" SkinID="SiteFeaturesMessage">
									...
									<asp:UpdatePanel ID="upWebParts" UpdateMode="Conditional" runat="server">
										<ContentTemplate>
											<portal:FormGroupPanel runat="server" SkinID="WebPartsLeft">
												<h3>
													<mp:SiteLabel ID="Sitelabel21" runat="server" ConfigKey="WebPartAdminAllWebParts" UseLabelTag="false" />
											...
											<portal:FormGroupPanel runat="server" SkinID="WebPartsLeft">
												<h3>
													<mp:SiteLabel ID="Sitelabel22" runat="server" ConfigKey="WebPartAdminSelectedWebParts" UseLabelTag="false" />
												</h3>
