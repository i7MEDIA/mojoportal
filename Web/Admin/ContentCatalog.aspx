						...
						<mp:mojoGridView ID="grdContent" runat="server"
							...
							<Columns>
								...
								<asp:TemplateField SortExpression="FeatureName">
									<ItemTemplate>
										<%# mojoPortal.Web.Framework.ResourceHelper.GetResourceString(DataBinder.Eval(Container.DataItem, "ResourceFile").ToString(),DataBinder.Eval(Container.DataItem, "FeatureName").ToString()) %>(<%# Eval("UseCount") %>)
									</ItemTemplate>
								</asp:TemplateField>
