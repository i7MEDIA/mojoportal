...
{
	public class CKEditor5Adapter : IWebEditor
	{
		public CKEditor5Adapter()
		{
			InitializeEditor();
		}
		...
		private CKEditor5Control Editor = new CKEditor5Control();
		...
		{
			//Editor.Skin = WebConfigSettings.CKEditor5Skin;
		}
