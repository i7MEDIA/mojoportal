...
<portal:CommentsOuterPanel ID="pnlOuterPanel" runat="server" RenderId="false" CssClass="comments">
	...
	<asp:Panel ID="pnlCommentsClosed" runat="server" EnableViewState="false" CssClass="comments-closed">
		<asp:Literal ID="litCommentsClosed" runat="server" EnableViewState="false" />
	</asp:Panel>

	<asp:Panel ID="pnlCommentsRequireAuthentication" runat="server" Visible="false" EnableViewState="false" CssClass="comments-require-auth">
		<portal:SignInOrRegisterPrompt ID="srPrompt" runat="server" />
	</asp:Panel>
</portal:CommentsOuterPanel>

<div id="divCommentService" runat="server" enableviewstate="false" class="comments comments-service">
