...
public class CheckBoxListAdapter : WebControlAdapter
{
	...
	{
		if (Control is not CheckBoxList checkBoxList)
		{
			return;
		}
		...
		foreach (ListItem item in checkBoxList.Items)
		{
			...
			writer.RenderEndTag();
			Page?.ClientScript.RegisterForEventValidation(checkBoxList.UniqueID, item.Value);
		}

		Page?.ClientScript.RegisterForEventValidation(checkBoxList.UniqueID);
	}
