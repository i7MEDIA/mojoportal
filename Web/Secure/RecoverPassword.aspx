...
<div class="modulecontent">
            ...
            <mp:SiteLabel ID="lblHead" runat="server" ConfigKey="ForgotPasswordLabel" Format="<%$ mojoCode:  DisplaySettings.DefaultPageHeaderMarkup %>" />
	<asp:Label ID="lbl" runat="server" Text="<%$ mojoCode: string.Format(DisplaySettings.DefaultPageHeaderMarkup, Resource.ForgotPasswordLabel) %>" />
