...
public partial class ForumEdit : NonCmsBasePage
{
	...
	private void PopulateLabels()
	{
		...
		litDisplayTab.Text = ForumResources.Display;
		litGeneralTab.Text = ForumResources.General;
		litPostMgtTab.Text = ForumResources.PostingAndModeration;
		litSearchIndexingTab.Text = ForumResources.SearchIndexing;
	...
	private void PopulateControls()
	{
		...
		this.txtTitle.Text = forum.Title.RemoveMarkup();
	...
	private void btnUpdate_Click(object sender, EventArgs e)
	{
		...
		forum.Title = txtTitle.Text.RemoveMarkup();
