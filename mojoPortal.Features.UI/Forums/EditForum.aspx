				...
				<portal:InnerBodyPanel ID="pnlInnerBody" runat="server" CssClass="modulecontent">
					<ul class="nav nav-tabs" id="tabContent">
						<li class="active"><a href="#general" data-toggle="tab">
							<asp:Literal ID="litGeneralTab" runat="server" EnableViewState="false" />
						</a></li>
						<li><a href="#display" data-toggle="tab">
							<asp:Literal ID="litDisplayTab" runat="server" EnableViewState="false" />
						</a></li>
						<li><a href="#postmgt" data-toggle="tab">
							<asp:Literal ID="litPostMgtTab" runat="server" EnableViewState="false" />
						</a></li>
						<%--						<li><a href="#notifications" data-toggle="tab">
							<asp:Literal ID="litNotificationsTab" runat="server" EnableViewState="false" />
						</a></li>--%>
						<li><a href="#searchindexing" data-toggle="tab">
							<asp:Literal ID="litSearchIndexingTab" runat="server" EnableViewState="false" />
						</a></li>
					</ul>
					...
					<asp:Panel ID="pnlEdit" runat="server" DefaultButton="btnUpdate">
						<div class="tab-content">
							<div class="tab-pane active" id="general">
								<div class="settingrow">
									<mp:SiteLabel ID="lblTitleLabel" runat="server" ForControl="txtTitle" CssClass="settinglabel"
										ConfigKey="ForumEditTitleLabel" ResourceFile="ForumResources">
									</mp:SiteLabel>
							...
							<div class="tab-pane" id="postmgt">
								<div class="settingrow">
									<mp:SiteLabel ID="lblAllowAnonymousPosts" runat="server"
										CssClass="settinglabel" ConfigKey="RolesThatCanPost" ResourceFile="ForumResources">
									</mp:SiteLabel>
								...
								<div class="settingrow" id="divIsModerated" runat="server">
									<mp:SiteLabel ID="lblIsModeratedLabel" runat="server" ForControl="chkIsModerated"
										CssClass="settinglabel" ConfigKey="ForumEditIsModeratedLabel" ResourceFile="ForumResources">
									</mp:SiteLabel>
								...
								<div class="settingrow">
									<mp:SiteLabel ID="SiteLabel8" runat="server"
										CssClass="settinglabel" ConfigKey="RolesThatCanModerate" ResourceFile="ForumResources">
									</mp:SiteLabel>
								...
								<div class="settingrow">
									<mp:SiteLabel ID="SiteLabel3" runat="server" ForControl="txtTitle" CssClass="settinglabel"
										ConfigKey="ModeratorNotifyEmail" ResourceFile="ForumResources">
									</mp:SiteLabel>
							...
							<div class="tab-pane" id="searchindexing">
								<div class="settingrow">
