<%@ Page Language="c#" CodeBehind="XmlEdit.aspx.cs" MasterPageFile="~/App_MasterPages/layout.Master" AutoEventWireup="false" Inherits="mojoPortal.Web.XmlUI.EditXml" %>
				...
				<portal:InnerBodyPanel ID="pnlInnerBody" runat="server" CssClass="modulecontent">
					<asp:Panel ID="pnlEdit" runat="server" DefaultButton="updateButton">
						...
						<div class="settingrow">
							...
							<portal:mojoLabel runat="server" ID="lblXmlUrlValidationSummary" Visible="false" CssClass="txterror errors" EnableViewState="false" />
						</div>
						...
						<div class="settingrow">
							...
							<portal:mojoLabel runat="server" ID="lblXslUrlValidationSummary" Visible="false" CssClass="txterror errors" EnableViewState="false" />
						</div>
