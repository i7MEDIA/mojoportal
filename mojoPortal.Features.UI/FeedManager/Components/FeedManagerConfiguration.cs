...
public class FeedManagerConfiguration
{
	...
	public static bool UseReadWriteLockForCacheMenagement => ConfigHelper.GetBoolProperty("FeedManager:UseReadWriteLockForCacheMenagement", false);
	...
	public FeedManagerConfiguration(Hashtable settings) => LoadSettings(settings);
	...
	private void LoadSettings(Hashtable settings)
	{
		...
		ExcerptSuffix = WebUtils.ParseStringFromHashtable(settings, "RSSAggregatorExcerptSuffixSetting", ExcerptSuffix);
		...
		ListLabel = WebUtils.ParseStringFromHashtable(settings, "RSSFeedListLabelSetting", ListLabel);
