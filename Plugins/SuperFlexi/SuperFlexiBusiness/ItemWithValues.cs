...
public class ItemWithValues
{
		...
		string sortDirection = "ASC")
	{
		return LoadListFromReader(
			DBItems.GetForModuleWithValues(
	...
	{
		return LoadListFromReader(
			DBItems.GetForDefinitionWithValues(
				defGuid: defGuid,
				siteGuid: siteGuid,
				pageNumber: pageNumber,
				pageSize: pageSize,
		...
		try
		{
			...
			while (reader.Read())
			{
				...
				try
				{
					...
					itemList.Where(i => i.Item.ItemGuid == itemWithValues.Item.ItemGuid)
						.First()
						.Values
