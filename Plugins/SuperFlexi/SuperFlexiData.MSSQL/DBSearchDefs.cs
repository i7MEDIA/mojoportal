...
public static class DBSearchDefs
{
	...
	{
		var sph = new SqlParameterHelper(ConnectionString.GetWriteConnectionString(), "i7_sflexi_searchdefs_Insert", 9);
	...
	public static bool Update(
		...
		string linkQueryAddendum)
	{
		var sph = new SqlParameterHelper(ConnectionString.GetWriteConnectionString(), "i7_sflexi_searchdefs_Update", 9);
		sph.DefineSqlParameter("@Guid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, guid);
		sph.DefineSqlParameter("@SiteGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, siteGuid);
		sph.DefineSqlParameter("@FeatureGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, featureGuid);
		sph.DefineSqlParameter("@FieldDefinitionGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, definitionGuid);
	...
	{
		var sph = new SqlParameterHelper(ConnectionString.GetWriteConnectionString(), "i7_sflexi_searchdefs_DeleteByFieldDefinition", 1);
	...
	{
		var sph = new SqlParameterHelper(ConnectionString.GetWriteConnectionString(), "i7_sflexi_searchdefs_DeleteBySite", 1);
		sph.DefineSqlParameter("@SiteGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, siteGuid);
		int rowsAffected = sph.ExecuteNonQuery();
		return rowsAffected > 0;
	}
	...
	{
		var sph = new SqlParameterHelper(ConnectionString.GetWriteConnectionString(), "i7_sflexi_searchdefs_Delete", 1);
		sph.DefineSqlParameter("@Guid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, guid);
		int rowsAffected = sph.ExecuteNonQuery();
		return rowsAffected > 0;
	}
	...
	{
		var sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "i7_sflexi_searchdefs_SelectByFieldDefinition", 1);
	...
	{
		var sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "i7_sflexi_searchdefs_SelectOne", 1);
		sph.DefineSqlParameter("@Guid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, guid);
		return sph.ExecuteReader();
	}
}
