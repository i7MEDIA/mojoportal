...
public static class DBFields
{
	...
	public static int Create(
		...
		string editRoles)
	{
		var sph = new SqlParameterHelper(ConnectionString.GetWriteConnectionString(), "i7_sflexi_fields_Insert", 44);
	...
	public static bool Update(
		...
		string editRoles)
	{
		var sph = new SqlParameterHelper(ConnectionString.GetWriteConnectionString(), "i7_sflexi_fields_Update", 45);
		sph.DefineSqlParameter("@FieldGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, fieldGuid);
		sph.DefineSqlParameter("@SiteGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, siteGuid);
		sph.DefineSqlParameter("@FeatureGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, featureGuid);
		sph.DefineSqlParameter("@DefinitionGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, definitionGuid);
	...
	{
		var sph = new SqlParameterHelper(ConnectionString.GetWriteConnectionString(), "i7_sflexi_fields_Delete", 1);
		sph.DefineSqlParameter("@FieldGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, fieldGuid);
	...
	{
		var sph = new SqlParameterHelper(ConnectionString.GetWriteConnectionString(), "i7_sflexi_fields_DeleteBySite", 1);
		sph.DefineSqlParameter("@SiteGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, siteGuid);
		int rowsAffected = sph.ExecuteNonQuery();
		return rowsAffected > 0;
	}
	...
	{
		var sph = new SqlParameterHelper(ConnectionString.GetWriteConnectionString(), "i7_sflexi_fields_DeleteByDefinition", 1);
		sph.DefineSqlParameter("@DefinitionGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, definitionGuid);
		int rowsAffected = sph.ExecuteNonQuery();
		return rowsAffected > 0;
	}
	...
	{
		var sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "i7_sflexi_fields_SelectOne", 1);
		sph.DefineSqlParameter("@FieldGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, fieldGuid);
	...
	{
		var sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "i7_sflexi_fields_SelectAllForDefinition", 2);
		sph.DefineSqlParameter("@DefinitionGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, definitionGuid);
		...
		out int totalPages)
	{
		...
		var sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "i7_sflexi_fields_SelectPage", 2);
	...
	{
		var sph = new SqlParameterHelper(ConnectionString.GetWriteConnectionString(), "i7_sflexi_fields_MarkAsDeleted", 1);
		sph.DefineSqlParameter("@FieldGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, fieldGuid);
		int rowsAffected = sph.ExecuteNonQuery();
		return rowsAffected > 0;
	}
