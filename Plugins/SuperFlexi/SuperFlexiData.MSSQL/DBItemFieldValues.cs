...
public static class DBItemFieldValues
{
	...
	public static int Create(
		...
		string fieldValue)
	{
		var sph = new SqlParameterHelper(ConnectionString.GetWriteConnectionString(), "i7_sflexi_values_Insert", 7);
	...
	public static bool Update(
		...
		string fieldValue)
	{
		var sph = new SqlParameterHelper(ConnectionString.GetWriteConnectionString(), "i7_sflexi_values_Update", 7);
		sph.DefineSqlParameter("@ValueGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, valueGuid);
		sph.DefineSqlParameter("@SiteGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, siteGuid);
		sph.DefineSqlParameter("@FeatureGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, featureGuid);
		sph.DefineSqlParameter("@ModuleGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, moduleGuid);
	...
	{
		var sph = new SqlParameterHelper(ConnectionString.GetWriteConnectionString(), "i7_sflexi_values_Delete", 1);
		sph.DefineSqlParameter("@ValueGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, valueGuid);
		int rowsAffected = sph.ExecuteNonQuery();
		return rowsAffected > 0;
	}
	...
	{
		var sph = new SqlParameterHelper(ConnectionString.GetWriteConnectionString(), "i7_sflexi_values_DeleteBySite", 1);
		sph.DefineSqlParameter("@SiteGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, siteGuid);
		int rowsAffected = sph.ExecuteNonQuery();
		return rowsAffected > 0;
	}
	...
	{
		var sph = new SqlParameterHelper(ConnectionString.GetWriteConnectionString(), "i7_sflexi_values_DeleteByModule", 1);
		sph.DefineSqlParameter("@ModuleGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, moduleGuid);
		int rowsAffected = sph.ExecuteNonQuery();
		return rowsAffected > 0;
	}
	...
	{
		var sph = new SqlParameterHelper(ConnectionString.GetWriteConnectionString(), "i7_sflexi_values_DeleteByField", 1);
		sph.DefineSqlParameter("@FieldGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, fieldGuid);
		int rowsAffected = sph.ExecuteNonQuery();
		return rowsAffected > 0;
	}
	...
	{
		var sph = new SqlParameterHelper(ConnectionString.GetWriteConnectionString(), "i7_sflexi_values_DeleteByItem", 1);
		sph.DefineSqlParameter("@ItemGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, itemGuid);
		int rowsAffected = sph.ExecuteNonQuery();
		return rowsAffected > 0;
	}
	...
	{
		var sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "i7_sflexi_values_SelectOne", 1);
		sph.DefineSqlParameter("@ValueGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, valueGuid);
	...
	/// </summary>
	public static IDataReader GetAll() => SqlHelper.ExecuteReader(
		ConnectionString.GetReadConnectionString(),
		CommandType.StoredProcedure,
	...
	/// <returns></returns>
	public static IDataReader GetByItemField(
		Guid itemGuid,
		Guid fieldGuid)
	{
		var sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "i7_sflexi_values_SelectOneByItemField", 2);
		sph.DefineSqlParameter("@ItemGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, itemGuid);
		sph.DefineSqlParameter("@FieldGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, fieldGuid);
		return sph.ExecuteReader();
	}
	...
	{
		var sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "i7_sflexi_values_SelectByItemGuids", 1);
	...
	{
		var sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "i7_sflexi_values_SelectAllByItemGuid", 1);
		sph.DefineSqlParameter("@ItemGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, itemGuid);
		return sph.ExecuteReader();
	}
	...
	{
		var sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "i7_sflexi_values_SelectAllByModuleGuid", 1);
		sph.DefineSqlParameter("@ModuleGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, moduleGuid);
		return sph.ExecuteReader();
	}
	...
	{
		var sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "i7_sflexi_values_SelectAllByDefinitionGuid", 1);
	...
	{
		var sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "i7_sflexi_values_SelectByGuid", 1);
		sph.DefineSqlParameter("@FieldGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, fieldGuid);
		return sph.ExecuteReader();
	}

	public static IDataReader GetByFieldGuidForModule(
		Guid fieldGuid,
		Guid moduleGuid)
	{
		var sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "i7_sflexi_values_SelectByGuidForModule", 2);
		sph.DefineSqlParameter("@FieldGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, fieldGuid);
		sph.DefineSqlParameter("@ModuleGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, moduleGuid);
		return sph.ExecuteReader();
	}

	public static IDataReader GetByGuidForModule(
		Guid fieldGuid,
		Guid moduleGuid)
	{
		var sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "i7_sflexi_values_SelectByGuidForModule", 2);
	...
	public static IDataReader GetByGuidForModule(
		...
		int moduleId)
	{
		var sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "i7_sflexi_values_SelectByGuidForModuleById", 2);
		sph.DefineSqlParameter("@FieldGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, fieldGuid);
		...
		out int totalPages)
	{
		...
		var sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "i7_sflexi_values_SelectPage", 2);
		sph.DefineSqlParameter("@PageNumber", SqlDbType.Int, ParameterDirection.Input, pageNumber);
		sph.DefineSqlParameter("@PageSize", SqlDbType.Int, ParameterDirection.Input, pageSize);
		return sph.ExecuteReader();
	}
