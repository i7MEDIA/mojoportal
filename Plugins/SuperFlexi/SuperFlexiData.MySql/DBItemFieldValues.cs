...
public static class DBItemFieldValues
{
	...
	)
	{
		...
		MySqlParameter[] sqlParams = [
			...
			new ("?ValueGuid", MySqlDbType.Guid) { Direction = ParameterDirection.Input, Value = valueGuid },
			new ("?FieldValue", MySqlDbType.LongText) { Direction = ParameterDirection.Input, Value = fieldValue }
		];
	...
	public static bool DeleteBySite(Guid siteGuid)
	{
		...
		int rowsAffected = MySqlHelper.ExecuteNonQuery(ConnectionString.GetWriteConnectionString(), sqlCommand, sqlParam);
	...
	public static IDataReader GetAll()
	{
		...
		return MySqlHelper.ExecuteReader(ConnectionString.GetWriteConnectionString(), sqlCommand);
	}
		...
		bool descending = false)
	{
		...
		MySqlParameter[] sqlParams = [
			...
			new("?Field", MySqlDbType.VarChar, 50) { Direction = ParameterDirection.Input, Value = field },
			new("?ModuleGuid", MySqlDbType.Guid) { Direction = ParameterDirection.Input, Value = moduleGuid },
		];
