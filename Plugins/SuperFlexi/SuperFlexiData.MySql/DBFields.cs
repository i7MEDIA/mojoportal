...
public static class DBFields
{
	...
	)
	{
		...
		var sqlParams = new MySqlParameter[]
		{
			...
			new("?FieldGuid", MySqlDbType.Guid) { Direction = ParameterDirection.Input, Value = fieldGuid },
			new("?DefinitionName", MySqlDbType.VarChar, 50) { Direction = ParameterDirection.Input, Value = definitionName },
			new("?Name", MySqlDbType.VarChar, 50) { Direction = ParameterDirection.Input, Value = name },
			new("?Label", MySqlDbType.VarChar, 255) { Direction = ParameterDirection.Input, Value = label },
			new("?DefaultValue", MySqlDbType.LongText) { Direction = ParameterDirection.Input, Value = defaultValue },
			new("?ControlType", MySqlDbType.VarChar, 16) { Direction = ParameterDirection.Input, Value = controlType },
			new("?ControlSrc", MySqlDbType.VarChar, 255) { Direction = ParameterDirection.Input, Value = controlSrc },
			new("?DataType", MySqlDbType.VarChar, 100) { Direction = ParameterDirection.Input, Value = dataType },
			new("?IsList", MySqlDbType.Bit) { Direction = ParameterDirection.Input, Value = isList },
			...
			new("?Required", MySqlDbType.Bit) { Direction = ParameterDirection.Input, Value = required },
			new("?RequiredMessageFormat", MySqlDbType.VarChar, 255) { Direction = ParameterDirection.Input, Value = requiredMessageFormat },
			new("?Regex", MySqlDbType.VarChar, 255) { Direction = ParameterDirection.Input, Value = regex },
			new("?RegexMessageFormat", MySqlDbType.VarChar, 255) { Direction = ParameterDirection.Input, Value = regexMessageFormat },
			new("?Token", MySqlDbType.VarChar, 50) { Direction = ParameterDirection.Input, Value = token },
			new("?PreTokenString", MySqlDbType.Text) { Direction = ParameterDirection.Input, Value = preTokenString },
			new("?PostTokenString", MySqlDbType.Text) { Direction = ParameterDirection.Input, Value = postTokenString },
			new("?PreTokenStringWhenTrue", MySqlDbType.Text) { Direction = ParameterDirection.Input, Value = preTokenStringWhenTrue },
			new("?PostTokenStringWhenTrue", MySqlDbType.Text) { Direction = ParameterDirection.Input, Value = postTokenStringWhenTrue },
			new("?PreTokenStringWhenFalse", MySqlDbType.Text) { Direction = ParameterDirection.Input, Value = preTokenStringWhenFalse },
			new("?PostTokenStringWhenFalse", MySqlDbType.Text) { Direction = ParameterDirection.Input, Value = postTokenStringWhenFalse },
			new("?Searchable", MySqlDbType.Bit) { Direction = ParameterDirection.Input, Value = searchable },
			new("?EditPageControlWrapperCssClass", MySqlDbType.VarChar, 50) { Direction = ParameterDirection.Input, Value = editPageControlWrapperCssClass },
			new("?EditPageLabelCssClass", MySqlDbType.VarChar, 50) { Direction = ParameterDirection.Input, Value = editPageLabelCssClass },
			new("?EditPageControlCssClass", MySqlDbType.VarChar, 50) { Direction = ParameterDirection.Input, Value = editPageControlCssClass },
			new("?DatePickerIncludeTimeForDate", MySqlDbType.Bit) { Direction = ParameterDirection.Input, Value = datePickerIncludeTimeForDate },
			new("?DatePickerShowMonthList", MySqlDbType.Bit) { Direction = ParameterDirection.Input, Value = datePickerShowMonthList },
			new("?DatePickerShowYearList", MySqlDbType.Bit) { Direction = ParameterDirection.Input, Value = datePickerShowYearList },
			new("?DatePickerYearRange", MySqlDbType.VarChar, 10) { Direction = ParameterDirection.Input, Value = datePickerYearRange },
			new("?ImageBrowserEmptyUrl", MySqlDbType.VarChar, 255) { Direction = ParameterDirection.Input, Value = imageBrowserEmptyUrl },
			new("?Options", MySqlDbType.Text) { Direction = ParameterDirection.Input, Value = options },
			new("?CheckBoxReturnBool", MySqlDbType.Bit) { Direction = ParameterDirection.Input, Value = checkBoxReturnBool },
			new("?CheckBoxReturnValueWhenTrue", MySqlDbType.Text) { Direction = ParameterDirection.Input, Value = checkBoxReturnValueWhenTrue },
			new("?CheckBoxReturnValueWhenFalse", MySqlDbType.Text) { Direction = ParameterDirection.Input, Value = checkBoxReturnValueWhenFalse },
			new("?DateFormat", MySqlDbType.VarChar, 255) { Direction = ParameterDirection.Input, Value = dateFormat },
			new("?TextBoxMode", MySqlDbType.VarChar, 25) { Direction = ParameterDirection.Input, Value = textBoxMode },
			new("?Attributes", MySqlDbType.VarChar, 255) { Direction = ParameterDirection.Input, Value = attributes },
			new("?IsGlobal", MySqlDbType.Bit) { Direction = ParameterDirection.Input, Value = isGlobal },
			new("?ViewRoles", MySqlDbType.VarChar, 255) { Direction = ParameterDirection.Input, Value = viewRoles },
			new("?EditRoles", MySqlDbType.VarChar, 255) { Direction = ParameterDirection.Input, Value = editRoles }
		};
	...
	)
	{
		...
		var sqlParams = new MySqlParameter[]
		{
			...
			new("?ControlType", MySqlDbType.VarChar, 16) { Direction = ParameterDirection.Input, Value = controlType },
			new("?ControlSrc", MySqlDbType.VarChar, 255) { Direction = ParameterDirection.Input, Value = controlSrc },
			new("?DataType", MySqlDbType.VarChar, 500) { Direction = ParameterDirection.Input, Value = dataType },
			new("?IsList", MySqlDbType.Bit) { Direction = ParameterDirection.Input, Value = isList },
			new("?SortOrder", MySqlDbType.Int32) { Direction = ParameterDirection.Input, Value = sortOrder },
			new("?HelpKey", MySqlDbType.VarChar, 255) { Direction = ParameterDirection.Input, Value = helpKey },
			new("?Required", MySqlDbType.Bit) { Direction = ParameterDirection.Input, Value = required },
			...
			new("?TextBoxMode", MySqlDbType.VarChar, 25) { Direction = ParameterDirection.Input, Value = textBoxMode },
			new("?Attributes", MySqlDbType.VarChar, 255) { Direction = ParameterDirection.Input, Value = attributes },
			new("?IsDeleted", MySqlDbType.Bit) { Direction = ParameterDirection.Input, Value = isDeleted },
			new("?IsGlobal", MySqlDbType.Bit) { Direction = ParameterDirection.Input, Value = isGlobal },
			new("?ViewRoles", MySqlDbType.VarChar, 255) { Direction = ParameterDirection.Input, Value = viewRoles },
			new("?EditRoles", MySqlDbType.VarChar, 255) { Direction = ParameterDirection.Input, Value = editRoles }
		};
	...
	/// </summary>
	public static IDataReader GetAll() => MySqlHelper.ExecuteReader(
		ConnectionString.GetWriteConnectionString(),
	...
	public static IDataReader GetAllForDefinition(Guid definitionGuid, bool includeDeleted = false)
	{
		...
		{
			new("?DefinitionGuid", MySqlDbType.Guid) { Direction = ParameterDirection.Input, Value = definitionGuid },
			new("?IncludeDeleted", MySqlDbType.Bit) { Direction = ParameterDirection.Input, Value = includeDeleted }
		};

		return MySqlHelper.ExecuteReader(ConnectionString.GetWriteConnectionString(), sqlCommand, sqlParams);
	}
		...
		out int totalPages)
	{
		...
		MySqlParameter[] sqlParams = [
			...
			new("?OffsetRows", MySqlDbType.Int32) { Direction = ParameterDirection.Input, Value = pageLowerBound }
		];

		return MySqlHelper.ExecuteReader(ConnectionString.GetReadConnectionString(), sqlCommand, sqlParams);
	}
	...
	{
		var sqlCommand = "UPDATE `i7_sflexi_fields` SET `IsDeleted` = 1 WHERE `FieldGuid` = ?FieldGuid;";
