...
using mojoPortal.Data.EF.EntityConfigurations;
...
namespace mojoPortal.Data.EF
{
	public partial class mojoPortalDbContext : DbContext
	{
		...
		public mojoPortalDbContext(string connectionString) : base(connectionString)
		{ }
		...
		//public virtual DbSet<CommerceReportOrder> CommerceReportOrders { get; set; }
		...
		//public virtual DbSet<FriendlyUrl> FriendlyUrls { get; set; }
		...
		public mojoPortalDbContext ReadConnection() => new mojoPortalDbContext(ConnectionString.GetReadConnectionString());
		...
		protected override void OnModelCreating(DbModelBuilder modelBuilder)
		{
			...
			//modelBuilder.Configurations.Add(new BannedIPAddressesConfiguration());
			...
			//modelBuilder.Entity<CommerceReportOrder>()
			//	.Property(e => e.SubTotal)
			//	.HasPrecision(15, 4);
