...
public static class DBModule
{
	...
	)
	{
		...
		NpgsqlParameter[] arParams = [
			...
			new NpgsqlParameter(":moduletitle", NpgsqlTypes.NpgsqlDbType.Varchar, 255) { Direction = ParameterDirection.Input, Value = moduleTitle },
			new NpgsqlParameter(":authorizededitroles", NpgsqlTypes.NpgsqlDbType.Text) { Direction = ParameterDirection.Input, Value = authorizedEditRoles },
			new NpgsqlParameter(":cachetime", NpgsqlTypes.NpgsqlDbType.Integer) { Direction = ParameterDirection.Input, Value = cacheTime },
			new NpgsqlParameter(":showtitle", NpgsqlTypes.NpgsqlDbType.Boolean) { Direction = ParameterDirection.Input, Value = showTitle },
			new NpgsqlParameter(":edituserid", NpgsqlTypes.NpgsqlDbType.Integer) { Direction = ParameterDirection.Input, Value = -1 },
			new NpgsqlParameter(":icon", NpgsqlTypes.NpgsqlDbType.Varchar, 255) { Direction = ParameterDirection.Input, Value = icon },
			new NpgsqlParameter(":createdbyuserid", NpgsqlTypes.NpgsqlDbType.Integer) { Direction = ParameterDirection.Input, Value = createdByUserId },
			new NpgsqlParameter(":createddate", NpgsqlTypes.NpgsqlDbType.Timestamp) { Direction = ParameterDirection.Input, Value = createdDate },
			new NpgsqlParameter(":countofuseonmypage", NpgsqlTypes.NpgsqlDbType.Integer) { Direction = ParameterDirection.Input, Value = 0 },
			new NpgsqlParameter(":guid", NpgsqlTypes.NpgsqlDbType.Char, 36) { Direction = ParameterDirection.Input, Value = guid.ToString() },
			...
			new NpgsqlParameter(":edituserguid", NpgsqlTypes.NpgsqlDbType.Char, 36) { Direction = ParameterDirection.Input, Value = Guid.Empty.ToString() },
			new NpgsqlParameter(":hidefromunauth", NpgsqlTypes.NpgsqlDbType.Boolean) { Direction = ParameterDirection.Input, Value = hideFromUnauthenticated },
			new NpgsqlParameter(":hidefromauth", NpgsqlTypes.NpgsqlDbType.Boolean) { Direction = ParameterDirection.Input, Value = hideFromAuthenticated },
			new NpgsqlParameter(":viewroles", NpgsqlTypes.NpgsqlDbType.Text) { Direction = ParameterDirection.Input, Value = viewRoles },
			new NpgsqlParameter(":drafteditroles", NpgsqlTypes.NpgsqlDbType.Text) { Direction = ParameterDirection.Input, Value = draftEditRoles },
			new NpgsqlParameter(":headelement", NpgsqlTypes.NpgsqlDbType.Varchar, 25) { Direction = ParameterDirection.Input, Value = headElement },
	...
	)
	{
		...
		NpgsqlParameter[] arParams = [
			new NpgsqlParameter(":moduleid", NpgsqlTypes.NpgsqlDbType.Integer) { Direction = ParameterDirection.Input, Value = moduleId },
			new NpgsqlParameter(":moduletitle", NpgsqlTypes.NpgsqlDbType.Varchar, 255) { Direction = ParameterDirection.Input, Value = moduleTitle },
			new NpgsqlParameter(":authorizededitroles", NpgsqlTypes.NpgsqlDbType.Text) { Direction = ParameterDirection.Input, Value = authorizedEditRoles },
			new NpgsqlParameter(":cachetime", NpgsqlTypes.NpgsqlDbType.Integer) { Direction = ParameterDirection.Input, Value = cacheTime },
			new NpgsqlParameter(":showtitle", NpgsqlTypes.NpgsqlDbType.Boolean) { Direction = ParameterDirection.Input, Value = showTitle },
			new NpgsqlParameter(":edituserid", NpgsqlTypes.NpgsqlDbType.Integer) { Direction = ParameterDirection.Input, Value = editUserId },
			new NpgsqlParameter(":icon", NpgsqlTypes.NpgsqlDbType.Varchar, 255) { Direction = ParameterDirection.Input, Value = icon },
			new NpgsqlParameter(":hidefromunauth", NpgsqlTypes.NpgsqlDbType.Boolean) { Direction = ParameterDirection.Input, Value = hideFromUnauthenticated },
			new NpgsqlParameter(":hidefromauth", NpgsqlTypes.NpgsqlDbType.Boolean) { Direction = ParameterDirection.Input, Value = hideFromAuthenticated },
			new NpgsqlParameter(":viewroles", NpgsqlTypes.NpgsqlDbType.Text) { Direction = ParameterDirection.Input, Value = viewRoles },
			new NpgsqlParameter(":drafteditroles", NpgsqlTypes.NpgsqlDbType.Text) { Direction = ParameterDirection.Input, Value = draftEditRoles },
			new NpgsqlParameter(":includeinsearch", NpgsqlTypes.NpgsqlDbType.Boolean) { Direction = ParameterDirection.Input, Value = includeInSearch },
			new NpgsqlParameter(":isglobal", NpgsqlTypes.NpgsqlDbType.Boolean) { Direction = ParameterDirection.Input, Value = isGlobal },
			new NpgsqlParameter(":headelement", NpgsqlTypes.NpgsqlDbType.Varchar, 25) { Direction = ParameterDirection.Input, Value = headElement },
			new NpgsqlParameter(":draftapprovalroles", NpgsqlTypes.NpgsqlDbType.Text) { Direction = ParameterDirection.Input, Value = draftApprovalRoles },
			new NpgsqlParameter(":stylesets", NpgsqlTypes.NpgsqlDbType.Varchar, 255) { Direction = ParameterDirection.Input, Value = styleSets },
		];
