...
namespace mojoPortal.Business
{
	public class BannedIPAddress
	{
		...
		private bool Create()
		{
			RowId = DBBannedIP.Add(BannedIP, BannedUtc, BannedReason);
		...
		private bool Update()
		{
			return DBBannedIP.Update(RowId, BannedIP, BannedUtc, BannedReason);
		}
		...
		/// <returns>bool</returns>
		public static bool IsBanned(string ipAddress) => string.IsNullOrEmpty(ipAddress) ? false : DBBannedIP.IsBanned(ipAddress);
