				...
				<portal:InnerBodyPanel ID="pnlInnerBody" runat="server" CssClass="modulecontent">
					<asp:Panel ID="pnlEdit" runat="server" DefaultButton="updateButton">
						...
						<div class="settingrow row_vieworder">
							...
							<asp:TextBox ID="txtViewOrder" runat="server" MaxLength="10" CssClass="forminput smalltextbox" TextMode="Number" TabIndex="10" />
						</div>
						<div class="settingrow buttonrow row_buttons">
							...
							<asp:HyperLink ID="lnkCancel" runat="server" CssClass="cancellink" SkinID="TextButton" TabIndex="10" />
						</div>
					</asp:Panel>
