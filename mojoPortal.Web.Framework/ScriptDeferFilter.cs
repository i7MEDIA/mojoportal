...
public class ScriptDeferFilter : Stream
{
	...
	public ScriptDeferFilter(HttpResponse response)
	{
		...
		this.useHackyScriptExceptions = mojoPortal.Core.Configuration.ConfigHelper.GetBoolProperty("UseMojoScriptFilterExceptionsWhenCombiningJavaScript", this.useHackyScriptExceptions);
	}
