...
public static class DBPageSettings
{
		...
		string styleSets)
	{
		...
		var sph = new SqlParameterHelper(ConnectionString.GetWriteConnectionString(), "mp_Pages_Insert", 58);
		...
		sph.DefineSqlParameter("@StyleSets", SqlDbType.NVarChar, -1, ParameterDirection.Input, styleSets);
	...
	public static bool UpdatePage(
		...
		string styleSets)
	{
		SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetWriteConnectionString(), "mp_Pages_Update", 54);
		sph.DefineSqlParameter("@SiteID", SqlDbType.Int, ParameterDirection.Input, siteId);
		...
		sph.DefineSqlParameter("@StyleSets", SqlDbType.NVarChar, 255, ParameterDirection.Input, styleSets);
