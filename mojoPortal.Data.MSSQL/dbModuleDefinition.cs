...
public static class DBModuleDefinition
{
	...
	{
		var sph = new SqlParameterHelper(ConnectionString.GetWriteConnectionString(), "mp_ModuleDefinitionSettings_Update", 15);
		sph.DefineSqlParameter("@ModuleDefID", SqlDbType.Int, ParameterDirection.Input, moduleDefId);
		...
		sph.DefineSqlParameter("@Roles", SqlDbType.NVarChar, 255, ParameterDirection.Input, roles);
		sph.DefineSqlParameter("@ShowToUnauthorized", SqlDbType.Bit, ParameterDirection.Input, showToUnauthorized);
	...
	{
		var sph = new SqlParameterHelper(ConnectionString.GetWriteConnectionString(), "mp_ModuleDefinitionSettings_UpdateByID", 15);
		sph.DefineSqlParameter("@ID", SqlDbType.Int, ParameterDirection.Input, id);
		sph.DefineSqlParameter("@ModuleDefID", SqlDbType.Int, ParameterDirection.Input, moduleDefId);
		sph.DefineSqlParameter("@SettingName", SqlDbType.NVarChar, 50, ParameterDirection.Input, settingName);
		sph.DefineSqlParameter("@SettingValue", SqlDbType.NVarChar, -1, ParameterDirection.Input, settingValue);
