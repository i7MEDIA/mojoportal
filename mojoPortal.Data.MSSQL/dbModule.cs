...
public static class DBModule
{
	public static int AddModule(
		...
		string anchorName)
	{
		var sph = new SqlParameterHelper(ConnectionString.GetWriteConnectionString(), "mp_Modules_Insert", 25);
		...
		sph.DefineSqlParameter("@AnchorName", SqlDbType.NVarChar, ParameterDirection.Input, anchorName);
	...
	public static bool UpdateModule(
		...
		string anchorName)
	{
		var sph = new SqlParameterHelper(ConnectionString.GetWriteConnectionString(), "mp_Modules_Update", 20);
	...
	{
		var sph = new SqlParameterHelper(ConnectionString.GetWriteConnectionString(), "mp_Modules_UpdateModuleOrder", 4);
		sph.DefineSqlParameter("@PageID", SqlDbType.Int, ParameterDirection.Input, pageId);
		sph.DefineSqlParameter("@ModuleID", SqlDbType.Int, ParameterDirection.Input, moduleId);
		sph.DefineSqlParameter("@ModuleOrder", SqlDbType.Int, ParameterDirection.Input, moduleOrder);
		sph.DefineSqlParameter("@PaneName", SqlDbType.NVarChar, 50, ParameterDirection.Input, paneName);
	...
	{
		var sph = new SqlParameterHelper(ConnectionString.GetWriteConnectionString(), "mp_Modules_UpdatePage", 3);
	...
	{
		var sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_PageModule_Exists", 2);
		sph.DefineSqlParameter("@ModuleID", SqlDbType.Int, ParameterDirection.Input, moduleId);
		sph.DefineSqlParameter("@PageID", SqlDbType.Int, ParameterDirection.Input, pageId);
	...
	{
		var sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_PageModule_SelectByModule", 1);
		sph.DefineSqlParameter("@ModuleID", SqlDbType.Int, ParameterDirection.Input, moduleId);
	...
	{
		var sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_PageModule_SelectByPage", 1);
		sph.DefineSqlParameter("@PageID", SqlDbType.Int, ParameterDirection.Input, pageId);
		return sph.ExecuteReader();
	}
	...
	public static bool PageModuleInsert(
		...
		DateTime publishEndDate)
	{
		var sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_PageModules_Insert", 8);
	...
	public static bool PageModuleUpdate(
		...
		DateTime publishEndDate)
	{
		var sph = new SqlParameterHelper(ConnectionString.GetWriteConnectionString(), "mp_PageModules_Update", 6);
		sph.DefineSqlParameter("@ModuleID", SqlDbType.Int, ParameterDirection.Input, moduleId);
		sph.DefineSqlParameter("@PageID", SqlDbType.Int, ParameterDirection.Input, pageId);
		sph.DefineSqlParameter("@PaneName", SqlDbType.NVarChar, 50, ParameterDirection.Input, paneName);
		sph.DefineSqlParameter("@ModuleOrder", SqlDbType.Int, ParameterDirection.Input, moduleOrder);
	...
	{
		var sph = new SqlParameterHelper(ConnectionString.GetWriteConnectionString(), "mp_PageModules_DeleteByPage", 1);
		sph.DefineSqlParameter("@PageID", SqlDbType.Int, ParameterDirection.Input, pageId);
		int rowsAffected = sph.ExecuteNonQuery();
		return (rowsAffected > -1);
	}
	...
	{
		var sph = new SqlParameterHelper(ConnectionString.GetWriteConnectionString(), "mp_Modules_UpdateCountOfUseOnMyPage", 2);
		sph.DefineSqlParameter("@ModuleID", SqlDbType.Int, ParameterDirection.Input, moduleId);
	...
	{
		var sph = new SqlParameterHelper(ConnectionString.GetWriteConnectionString(), "mp_Modules_Delete", 1);
		sph.DefineSqlParameter("@ModuleID", SqlDbType.Int, ParameterDirection.Input, moduleId);
		int rowsAffected = sph.ExecuteNonQuery();
		return (rowsAffected > -1);
	}
	...
	{
		var sph = new SqlParameterHelper(ConnectionString.GetWriteConnectionString(), "mp_Modules_DeleteInstance", 2);
		sph.DefineSqlParameter("@ModuleID", SqlDbType.Int, ParameterDirection.Input, moduleId);
		sph.DefineSqlParameter("@PageID", SqlDbType.Int, ParameterDirection.Input, pageId);
		int rowsAffected = sph.ExecuteNonQuery();
		return (rowsAffected > -1);
	...
	{
		var sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Modules_SelectOne", 1);
		sph.DefineSqlParameter("@ModuleID", SqlDbType.Int, ParameterDirection.Input, moduleId);
		return sph.ExecuteReader();
	}
	...
	{
		var sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Modules_SelectOneByGuid", 1);
	...
	{
		var sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Modules_SelectOneByPage", 2);
		sph.DefineSqlParameter("@ModuleID", SqlDbType.Int, ParameterDirection.Input, moduleId);
		sph.DefineSqlParameter("@PageID", SqlDbType.Int, ParameterDirection.Input, pageId);
		return sph.ExecuteReader();
	}
	...
	{
		var sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Modules_SelectByPage", 2);
		sph.DefineSqlParameter("@PageID", SqlDbType.Int, ParameterDirection.Input, pageId);
	...
	{
		var sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Modules_SelectForMyPage", 1);
		sph.DefineSqlParameter("@SiteID", SqlDbType.Int, ParameterDirection.Input, siteId);
		return sph.ExecuteReader();
	}
	...
	{
		var sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Modules_SelectBySite", 2);
		sph.DefineSqlParameter("@SiteID", SqlDbType.Int, ParameterDirection.Input, siteId);
		sph.DefineSqlParameter("@FeatureGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, featureGuid);
		return sph.ExecuteReader();
	}
	...
	{
		var sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Modules_GetCount", 3);
		sph.DefineSqlParameter("@SiteID", SqlDbType.Int, ParameterDirection.Input, siteId);
		sph.DefineSqlParameter("@ModuleDefID", SqlDbType.Int, ParameterDirection.Input, moduleDefId);
		...
		out int totalPages)
	{
		...
		var sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Modules_SelectPage", 7);
		sph.DefineSqlParameter("@SiteID", SqlDbType.Int, ParameterDirection.Input, siteId);
		sph.DefineSqlParameter("@ModuleDefID", SqlDbType.Int, ParameterDirection.Input, moduleDefId);
		sph.DefineSqlParameter("@Title", SqlDbType.NVarChar, 255, ParameterDirection.Input, title);
	...
	public static int GetCountByFeature(int moduleDefId)
	{
		...
		var sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Modules_CountByFeature", 1);
		sph.DefineSqlParameter("@ModuleDefID", SqlDbType.Int, ParameterDirection.Input, moduleDefId);
	...
	{
		var sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Modules_GetGlobalCount", 3);
		sph.DefineSqlParameter("@SiteID", SqlDbType.Int, ParameterDirection.Input, siteId);
		sph.DefineSqlParameter("@ModuleDefID", SqlDbType.Int, ParameterDirection.Input, moduleDefId);
		sph.DefineSqlParameter("@PageID", SqlDbType.Int, ParameterDirection.Input, pageId);
		...
		out int totalPages)
	{
		...
		var sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Modules_SelectGlobalPage", 5);
		sph.DefineSqlParameter("@SiteID", SqlDbType.Int, ParameterDirection.Input, siteId);
		sph.DefineSqlParameter("@ModuleDefID", SqlDbType.Int, ParameterDirection.Input, moduleDefId);
		sph.DefineSqlParameter("@PageID", SqlDbType.Int, ParameterDirection.Input, pageId);
		sph.DefineSqlParameter("@PageNumber", SqlDbType.Int, ParameterDirection.Input, pageNumber);
	...
	{
		var sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "mp_Modules_SelectGlobalContent", 1);
		sph.DefineSqlParameter("@SiteID", SqlDbType.Int, ParameterDirection.Input, siteId);
		return sph.ExecuteReader();
	}
}
