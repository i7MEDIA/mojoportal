...
public static class DBModule
{
	public static int AddModule(
		...
		string styleSets)
	{
		SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetWriteConnectionString(), "mp_Modules_Insert", 22);
	...
	public static bool UpdateModule(
		...
		string styleSets)
	{
		SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetWriteConnectionString(), "mp_Modules_Update", 17);
